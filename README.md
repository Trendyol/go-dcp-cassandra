...
| `cassandra.useBatch`                                    | bool                     | no       | false   | Executes Cassandra writes using CQL batch statements                                               |
| `cassandra.batchType`                                   | string                   | no       | logged  | Batch type: logged, unlogged, or counter                                                           |
